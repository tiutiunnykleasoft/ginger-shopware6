# Ginger Payments plugin for Shopware 6
This is the official Ginger Payments plugin.
...
1. Create the 'gingerpay' folder in the directory <i><b>root</b></i>/custom/plugins/. Unzip your archive with the plugin to that folder.
...
5. Once you installed the plugin - offer the payment methods in your webshop.
    ...
    * Click on the empty space to see the list of Ginger Payments methods, and select the ones you want to add to the Shop.
